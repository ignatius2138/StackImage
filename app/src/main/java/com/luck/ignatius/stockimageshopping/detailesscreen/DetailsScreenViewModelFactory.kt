...
class DetailsScreenViewModelFactory(private val data: Data, private val application: Application, private val dataSource: CartTableDao): ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        @Suppress("unchecked_cast")
        if (modelClass.isAssignableFrom(DetailsScreenViewModel::class.java)) {
            return DetailsScreenViewModel(data, application, dataSource) as T
        }
